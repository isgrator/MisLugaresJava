...
/**
 * Created by Isabel María on 08/10/2017.
 */
...
public class LugaresVector implements Lugares{
    ...
    public static ArrayList<Lugar> ejemploLugares(){
        ...
        lugares.add(new Lugar("Escuela Politécnica Superior de Gandía","C/ Paranimf, 1 46730 Gandia (SPAIN)",-0.166093,38.995656,TipoLugar.EDUCACION,962849300, "http://www.epsg.upv.es","Uno de los mejores lugares para formarse.", 3));
